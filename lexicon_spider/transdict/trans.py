...
if __name__ == '__main__':
    ...
    sogou_dict_path = "../SogouDict/"

    for root, dirs, files in os.walk(sogou_dict_path):
        for filespath in files:
            if filespath.endswith(".scel"):
                dict_files.append(os.path.join(root, filespath))
    ...
    for f in dict_files:
        ...
        try:
            ...
            print "dict file ", f, "parse failed."
            continue
